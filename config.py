...
parser.add_argument('--use-rs-negative', action='store_true',
                    help='Enable relation-constrained negative samples')
parser.add_argument('--rs-negative-K', type=int, default=5,
                    help='The number of RS negative samples per sample')
parser.add_argument('--gnn_start_epoch', type=int, default=1,
                    help='Starting from which round of Phase 2 training')
parser.add_argument('--resume_path', type=str, default='',
                    help='Path of the Continuing Training Model (. mdl file)')
parser.add_argument('--use-identity-anchor', action='store_true',
                    help='Enable identity anchoring (Self-loop) in Synergy Expert. '
                         'Strategy: Add this flag for sparse graphs (WN18RR) to prevent collapse. '
                         'Do NOT add this flag for dense graphs (FB15k-237) to reduce noise.')
parser.add_argument('--use-hr-anchor', action='store_true',
                    help='Open identity anchor at the head entity end')
parser.add_argument('--use-tail-anchor', action='store_true',
                    help='Activate identity anchor at the tail entity end')
parser.add_argument('--density-threshold', type=int, default=-1,
                    help='Node density threshold.')
